...
BYCDetailModel bycDetailModelFromJson(String str) => BYCDetailModel.fromJson(json.decode(str));

String bycDetailModelToJson(BYCDetailModel data) => json.encode(data.toJson());

class BYCDetailModel {
  String iid;
  Result result;
  Status status;
  ...
  factory BYCDetailModel.fromJson(Map<String, dynamic> json) => BYCDetailModel(
    iid: json["iid"],
